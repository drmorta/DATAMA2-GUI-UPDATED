            ...
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                  <?php 
                    $supplier = $conn->query("SELECT * FROM supplier")->num_rows;
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                  <?php 
                     $item = $conn->query("SELECT * FROM manga")->num_rows;
          ...
          <!-- /.col -->
           ...
           <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">To be completed Purchase Order.</span>
                <span class="info-box-number">
                  <?php 
